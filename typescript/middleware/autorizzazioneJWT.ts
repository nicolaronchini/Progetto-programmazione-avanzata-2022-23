...
//let tok = jwt.sign({"email":"ronchini.nicola@outlook.it"},process.env.KEY);
//let tok = jwt.sign({"stato":"VALIDATED","id":[10,11,14],"email":"adrianomancini@gmail.com"},process.env.KEY);
//let tok = jwt.sign({"email":"ronchini.nicola@outlook.it","stato":"ciao"},process.env.KEY);
//let tok = jwt.sign({"ordinamento":"ASCe","email":"ronchini.nicola@outlook.it"},process.env.KEY);
...
//let tok = jwt.sign({"email":"ronchini.nicola@outlook.it","raggio":1000},process.env.KEY);
//let tok = jwt.sign({"formato":"pdf","email":"ronchini.nicola@outlook.it"},process.env.KEY);
//let tok = jwt.sign({"idVal":[8,10,14],"idRej":[9,11],"email":"ronchini.nicola@outlook.it"},process.env.KEY)
let tok = jwt.sign({"id":1,"email":"ronchini.nicola@outlook.it"},process.env.KEY)
